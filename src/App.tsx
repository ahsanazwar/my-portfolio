  ...
  return (
    <>
      ...
      <main className="bg-black pt-10 relative z-10"> 
          <img   src="pattern-left.png" className="custom-pattern fixed -left-7 bottom-7 -z-10 w-72 opacity-10"/>
          <img data-speed="0.8" src="pattern-right.png" className="custom-pattern fixed -right-7 bottom-7 -z-10 w-72 opacity-10"/>
        <WebLoader/>
        <MainBanner/>
        <Projects/>
        <Education/>
